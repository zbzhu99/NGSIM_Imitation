...
parser.add_argument("-data_dir", type=str, default="traffic-data/state-action-cost-v2/")
...
register(id="Traffic-v0", entry_point="traffic_gym:Simulator", kwargs=kwargs)

register(id="I-80-v0", entry_point="map_i80:I80", kwargs=kwargs)
