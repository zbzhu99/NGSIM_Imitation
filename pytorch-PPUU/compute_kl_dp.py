...
log_path = "/NAS2020/Workspaces/DRLGroup/zbzhu/lfo-ppuu/lfo/logs/gail-lfo-ppuu-final-no-pretrain--gp-4.0--spalpha-1.0--idbeta-0.5--rs-2.0/gail_lfo_ppuu_final_no_pretrain--gp-4.0--spalpha-1.0--idbeta-0.5--rs-2.0--2021_01_29_02_40_45--s-0"
model_path = os.path.join(log_path, "params.pkl")
...
if __name__ == "__main__":
    ...
    policy = ReparamTanhMultivariateGaussianLfOPolicy(
        ...
        stacked_obs_num=variant["env_specs"]["stacked_obs_num"],
        ego_obs_dim=variant["env_specs"]["ego_obs_dim"],
        state_predictor=model["state_predictor"].cpu(),
        inverse_dynamic=model["inverse_dynamic"].cpu(),
    )
